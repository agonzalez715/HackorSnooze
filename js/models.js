...
class User {
  ...
  async addFavorite(storyId) {
    ...
    this.favorites.push(response.data.story); // Assumes the API returns the updated story object
  ...
  async removeFavorite(storyId) {
    ...
    this.favorites = this.favorites.filter(story => story.storyId !== storyId); // Update the favorites array
    return response.data.story;
  }
  // Method to add a story to user's favorites
  async addFavorite(storyId) {
